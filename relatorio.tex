...
A análise da matriz de confusão (não apresentada em tabela devido ao espaço, mas calculada durante a avaliação) revela que os erros de classificação são minimizados tanto para a classe "Normal" quanto para a classe "Crise", indicando que o modelo generaliza bem e não apresenta viés de classe após o balanceamento implementado.
